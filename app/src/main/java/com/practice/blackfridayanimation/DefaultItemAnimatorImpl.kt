 ...
 */
open class DefaultItemAnimatorImpl() : SimpleItemAnimator() {
    ...
    fun animateMoveImpl(holder: ViewHolder, fromX: Int, fromY: Int, toX: Int, toY: Int) {
        ...
        animation.setDuration(moveDuration).setInterpolator(LinearInterpolator()).setListener(object : AnimatorListenerAdapter() {
            override fun onAnimationStart(animator: Animator) {
